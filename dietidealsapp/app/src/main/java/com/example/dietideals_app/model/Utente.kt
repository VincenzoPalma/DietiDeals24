...
class Utente(val id: String, val username: String,
             ...
             var aste: MutableSet<Asta> = mutableSetOf(), var offerte: MutableSet<Offerta> = mutableSetOf(),
             var notifiche: MutableSet<Notifica> = mutableSetOf(), var ruolo: RuoloUtente ,var descrizione: String?,
             var sitoWeb: String?, var indirizzo: String?, var instagram: String?, var facebook: String?, var twitter: String?
){
}