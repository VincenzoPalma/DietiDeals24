    ...
    ConstraintLayout(
        ...
        Row(
            modifier = Modifier
                ...
                .padding(8.dp),
            horizontalArrangement = Arrangement.Absolute.Left, verticalAlignment = Alignment.CenterVertically) {
            Icon(painter = painterResource(id = R.drawable.baseline_access_time_filled_24), contentDescription = null)
            Text("Tempo rimanente: ", fontSize = 20.sp,color=Color(colorRed))
            Text(
                formatTime(timeLeft),
                fontSize = 20.sp,
        ...
        Row(
            ...
            ElevatedButton(onClick = { openDialog.value = true }) {
                Row(verticalAlignment = Alignment.CenterVertically){
                    Icon(painter = painterResource(id = R.drawable.hand_money_cash_hold_svgrepo_com), contentDescription = null)
                    Text(text = "FAI UN OFFERTA")
                }
